...
pub const terminal_get_cursor_col = terminal.getCursorCol;
pub const terminal_get_cursor_row = terminal.getCursorRow;
pub const terminal_resize = terminal.resize;
pub const terminal_get_cell = terminal.getCell;
pub const terminal_get_cell_style = terminal.getCellStyle;
pub const terminal_dump_screen = terminal.dumpScreen;
...
pub const terminal_render_row_html_highlighted = terminal.renderRowHtmlHighlighted;
